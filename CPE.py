...
def CPE(df,DAG, ordinal_atts,targetClass, groupingAtt, fds,k, tau,actionable_atts, high, low , print_times = False):
    ...
    # # # # step 3 -
    start_time = time.time()
    #sol, exp, num, coverage = Algorithms.findSolGreedy(groups_dic, k, tau, high, low)
